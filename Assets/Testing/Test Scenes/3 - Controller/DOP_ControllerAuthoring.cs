...
namespace Test.Controller
{
    ...
    /// </summary>
    public class DOP_ControllerAuthoring : MonoBehaviour
    {
        ...
        class Baker : Baker<DOP_ControllerAuthoring>
        {
            public override void Bake(DOP_ControllerAuthoring authoring)
            {
